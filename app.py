...
# Nomes dos estados para filtragem
...
# Dicionario composto pelos estados e os porcentagem de IMPOSTO
...
estados_mva_aliquota = {"Pernambuco": [[1.4134, 20.50], [1.4134, 20.50], [0, 0, 20.50]], "Acre": [[1.6753, 4], [1.5357, 12], [0, 0, 19]],
                        ...
                        "Rio Grande do Norte": [[1.6961, 4], [1.5547, 12], [10, 0, 18]], "Sergipe": [[1.6966, 4], [1.5512, 12], [0, 1, 20]],
                        "Pará": [[1.6751, 4], [1.5355, 12], [36.84, 0, 19]], "Alagoas": [[1.6751, 4], [1.5355, 12], [0, 1, 20]],
                        "Tocantins": [[1.6961, 4], [1.5547, 12], [0, 0, 20]], "Rio de Janeiro": [[1.7406, 4], [1.5955, 12], [0, 2, 22]],
                        "Mato Grosso do Sul": [[1.4713, 4], [1.3487, 12], [0, 0, 17]]}


# Dados para filtragem da Nacionalidade
...
def icms_st():
    for i, y in estados_mva_aliquota.items():
        if i == select_estado and select_nacionalidade == "Importado":
            ...
            basecalculo = f"R$ {baseparacalculo:.2f}"
            ...
            sl.metric(label="Total à Pagar: ", value=totalacobra)
...
select_estado = sl.selectbox(
    "Qual estado destinatario? Selecione", key='estado', options=estados_brasileiros)
select_nacionalidade = sl.selectbox(
    "Qual a nacionalidade do produto? Selecione", key='nacionalidade', options=nacionalidade)
